...
- [x] Full 15-run strict experiment completed
- [x] Strict result summary generated from `results_strict/`
- [x] Final audit passed with `scripts/audit_strict_hydra_results.py results_strict`

Final status as of 2026-06-28: complete. The final report contains all 3
architectures x 5 seeds, and `docs/strict_hydra_scibert_results.md` reports
`Status: **complete**`.
